...
var RouteService = (function () {
    function RouteService(http, authService) {
        this.http = http;
        this.authService = authService;
        this.testUrl = 'http://localhost:8080/api/routeList';
        this.addRouteUrl = 'http://localhost:8080/api/route';
    }
    RouteService.prototype.getTest = function (searchStr) {
    ...
    RouteService.prototype.addRoute = function (route) {
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
    ...
    RouteService.prototype.updateRoute = function (id, route) {
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        headers.append('Authorization', this.authService.token);
        var options = new http_1.RequestOptions({ headers: headers });
